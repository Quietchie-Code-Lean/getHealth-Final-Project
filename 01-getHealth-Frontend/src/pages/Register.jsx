...
const Register = () => {
  ...
  const cardClass = "w-full max-w-2xl rounded-2xl border border-slate-200 bg-white p-8 shadow-sm";
  ...
  const tabsClass = "mb-8 grid grid-cols-2 rounded-lg bg-slate-100 p-1";
  const tabBaseClass = "rounded-md px-4 py-2.5 text-sm font-semibold transition";
  const tabActiveClass = `${tabBaseClass} bg-white text-blue-600 shadow-sm`;
  const tabInactiveClass = `${tabBaseClass} text-slate-600 hover:text-slate-900`;
