...
const PatientProfile = () => {
  ...
  const appointmentButtonClass = "rounded-lg bg-slate-800 px-5 py-2.5 text-center font-medium text-white transition hover:bg-slate-700";
              ...
              <div className={scheduleContentClass}>
                ...
                <div>
                  ...
                  <p className={scheduleTextClass}>
                    Find a healthcare professional and book an available appointment.
                  </p>
