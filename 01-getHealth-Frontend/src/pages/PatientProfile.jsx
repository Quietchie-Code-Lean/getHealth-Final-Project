...
const PatientProfile = () => {
  ...
  const scheduleCardClass = "rounded-2xl border border-slate-700 bg-slate-900 p-6 shadow-sm";
  const scheduleContentClass = "flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between";
  const scheduleTextClass = "text-slate-400";
  const appointmentButtonClass = "rounded-lg bg-violet-600 px-5 py-2.5 text-center font-medium text-white transition hover:bg-violet-500";
